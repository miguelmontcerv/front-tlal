      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <Link to="https://www.linkedin.com/in/miguel-monteros/" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <img src={linkedin} alt="github" className="icon"/>
              </Link>
            </li>

            <li className="ml-4">
              <Link to="https://github.com/miguelmontcerv?tab=repositories" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <img src={git} alt="github" className="icon"/>
              </Link>
            </li>

            <li className="ml-4">
              <Link to="https://www.instagram.com/miguel.chino.mont/" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Todos los derechos reservados a tlal-mx.</div>
